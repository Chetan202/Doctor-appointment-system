...
<head>
	...
	<link type="text/css" rel="stylesheet" href="doc_login.css">
	...
	<div class="body">
		<div class="container-1">
			...
			<form action="" method="post">
				...
				<button name="signin" id="signin" type="submit" class="btn btn-warning" style="margin-top: 50px;">Sign In</button>
				<button name="signup" id="signup" type="submit" class="btn btn-warning" style="margin-top: 50px;margin-left:30px;">Sign up</button>
			</form>
		</div>
	</div>
...
if (isset($_POST['signin'])) {
	...
	$query = "SELECT * FROM doctor WHERE username='$user' && password='$pwd' ";
